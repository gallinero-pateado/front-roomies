    ...
    <section className="flex flex-wrap gap-4 p-4">
      <div className="flex gap-10">
        <button
          className={
            page
              ? "bg-[#7B4B94]  text-white font-bold py-2 px-4 rounded-lg"
              : "  text-white font-bold py-2 px-4 rounded-lg bg-[#007a9a]"
          }
        ...
        <button
          className={
            page
              ? "bg-[#007a9a]  text-white font-bold py-2 px-4 rounded-lg"
              : "  text-white font-bold py-2 px-4 rounded-lg bg-[#7B4B94]"
          }
